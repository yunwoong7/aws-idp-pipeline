"""
Main SearchAgent class - High-level interface for Plan-Execute-Respond search agent
"""
...
class SearchAgent:
    """
    High-level SearchAgent interface with Plan-Execute-Respond pattern
    ...
    def __init__(
        ...
        """
        self.workflow = SearchAgentWorkflow(
            model_id=model_id,
        ...
        logger.info(f"SearchAgent initialized with model {model_id}")
    ...
    async def astream(
        ...
        **kwargs
        ...
        """
        Stream search response with Plan-Execute-Respond workflow
    ...
    async def ainvoke(
        ...
        **kwargs
        ...
        """
        Get complete search response without streaming
    ...
    async def startup(self):
        ...
        logger.info("SearchAgent startup completed")
